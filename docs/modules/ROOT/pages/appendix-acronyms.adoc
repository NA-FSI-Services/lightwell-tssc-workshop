...
|Usually *RHACS*; platform/image policy gates (Module 5)
...
|CycloneDX
|(name, not an acronym)
|SBOM format used for Maven / `syft` in this workshop (Module 4)
...
|Argo CD sync of workshop charts (Module 5)

|IdP
|Identity Provider
|Keycloak for RHTPA sign-in (Modules 3–4)
...
|Machine-readable `fixed` events naming `.rhlw-*` pins (Module 3)
...
|Image / BUILD policy enforcement (Module 5)

|RHDA
|Red Hat Dependency Analytics
|IDE shift-left client of TPA intelligence (Module 4 appendix)
...
|Keyless cosign (Fulcio / Rekor / TUF) in Module 5

|RHTPA / TPA
|Red Hat Trusted Profile Analyzer
|SBOM and advisory system of record (Module 4)

|SBOM
|Software Bill of Materials
|Component inventory (CycloneDX via `syft` in Module 4)
