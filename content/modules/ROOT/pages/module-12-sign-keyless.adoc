...
* TSSC keyless signing is the connected path for the *app* digest; xref:module-14-disconnected-verify.adoc[5.3] adds a key-based signature on the same digest.
