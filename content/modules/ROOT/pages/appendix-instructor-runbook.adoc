...
* Validate Jobs are scaffolded in `lw-poc-validate` (helper + report ConfigMaps + Job templates). Stubs still fail until V2-54 fills track checks. Until then, grade the commands in *Check* on each page. Do not invent a lock.
