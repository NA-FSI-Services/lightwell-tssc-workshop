...
== GitHub Dependabot and lab Maven pins
...
Lab fixtures on GitHub are `pom.xml.example`. Gitea seed renames them to `pom.xml` so learners still see a real Maven project. Keep it that way.
