...
image::argo-lw-poc-prod-outofsync.png[Argo Application lw-poc-prod after 6.2: workloads Healthy; Namespace remains OutOfSync,width=700,link=self,window=blank]
