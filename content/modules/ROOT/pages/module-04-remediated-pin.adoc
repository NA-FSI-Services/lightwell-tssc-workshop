...
Honor system: Track 3 still opens. When Validate Jobs ship, they grade the ConfigMap default property plus the tree tokens — not a screenshot. The `~/track-2-2/pom.xml` copy is for `mvn -f`.
