...
|Point Maven / pip clients and Nexus or Artifactory proxies at Lightwell remotes (or seeded mirrors). xref:module-03-enterprise-proxy.adoc[2.1] (Maven scored; pip / Artifactory callouts).
