...
{{ printf "https://tuf-%s.apps.%s" .Values.rhtas.namespace .Values.deployer.domain }}
{{- else -}}
...
{{- if .Values.deployer.domain -}}
{{ printf "https://fulcio-server-%s.apps.%s" .Values.rhtas.namespace .Values.deployer.domain }}
{{- end -}}
{{- end -}}

{{- define "admission.rekorUrlHint" -}}
{{- if .Values.deployer.domain -}}
{{ printf "https://rekor-server-%s.apps.%s" .Values.rhtas.namespace .Values.deployer.domain }}
{{- end -}}
{{- end -}}
