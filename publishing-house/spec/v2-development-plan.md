...
| ID | Title | Depends on |
|----|-------|------------|
| V2-10 | Dest registry + oc-mirror tooling; **do not** pre-stage the scored Hummingbird image | V2-1 |
...
| V2-22 | Health check / e2e: mirror job, cosign verify internal, admission deny | Phase 5 |
| V2-23 | Hermeto (or prefetch) ClusterTask + incomplete pipeline seed for 4.2 | V2-14 |
